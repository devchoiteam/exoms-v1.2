...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_select_table = document.querySelector(
    '.dt-select-table:not(.dt-shipping-register-hand, .dt-shipping-register-auto, .dt-daily-inbound-empty, .dt-daily-inbound-filled, .dt-daily-inbound-list, .dt-shipment-list-summary, .dt-shipment-list-manage)'
  );
  let dt_select;
  if (dt_select_table) {
